import { rakeGarden } from './help-suzuki-rake-his-garden';

describe('test suites for rakeGarden kata', () => {
  ...
  test.each(fixtures)('should return correct string', (res, arg) => {
    expect(rakeGarden(arg)).toBe(res);
  });
});
